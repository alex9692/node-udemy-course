...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = "pk.eyJ1IjoiYWxleDk2OTIiLCJhIjoiY2p6d3A1eGdlMDBzdzNkcW5udXlpdTlkdiJ9.ti4ZD30BuIZhsTOb7td0AA";
...
},{}],"udpateUser.js":[function(require,module,exports) {
"use strict";
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            _context.next = 3;
            return _axios.default.patch("http://localhost:8000/api/v1/users/updateMe", data);
...
function () {
  var _ref2 = _asyncToGenerator(
  /*#__PURE__*/
  regeneratorRuntime.mark(function _callee2(currentPassword, newPassword, confirmNewPassword) {
    var response;
    return regeneratorRuntime.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            _context2.prev = 0;
            _context2.next = 3;
            return _axios.default.patch("http://localhost:8000/api/v1/users/updateMyPassword", {
          ...
          case 3:
            ...
            if (response.data.status === "success") {
              (0, _alert.showAlert)("success", "user password updated successfully!"); // location.reload(true);
            }
...
var stripe = Stripe("pk_test_pyY1zKCQesvnmM7ylC4SN0bo00fN3tMNCX");
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            _context.next = 3;
            return _axios.default.get("http://localhost:8000/api/v1/bookings/checkout-session/".concat(tourId));
...
var _udpateUser = require("./udpateUser");
...
if (updateUserDataForm) {
  updateUserDataForm.addEventListener("submit", function (e) {
    ...
    (0, _udpateUser.updateUserData)(form);
  });
}

if (updateUserPasswordForm) {
  updateUserPasswordForm.addEventListener("submit",
  /*#__PURE__*/
  function () {
    var _ref = _asyncToGenerator(
    /*#__PURE__*/
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              currentPassword = document.querySelector("#password-current.form__input").value;
              newPassword = document.querySelector("#password.form__input").value;
              confirmNewPassword = document.querySelector("#password-confirm.form__input").value;
              _context.next = 7;
              return (0, _udpateUser.updateUserPassword)(currentPassword, newPassword, confirmNewPassword);
